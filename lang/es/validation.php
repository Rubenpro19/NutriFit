...
return [
    ...
    */
    ...
    'uploaded' => 'El archivo :attribute no se pudo subir. El tamaño del archivo excede el límite permitido por el servidor.',
    ...
    */
    ...
    'custom' => [
        ...
        'profile_photo' => [
            'uploaded' => 'La foto de perfil es demasiado grande. El tamaño máximo permitido es 5MB. Por favor, reduce el tamaño de la imagen o ajusta la configuración del servidor.',
            'max' => 'La foto de perfil no puede ser mayor a 5MB.',
            'image' => 'El archivo debe ser una imagen válida (JPG, PNG, GIF).',
        ],
    ],
