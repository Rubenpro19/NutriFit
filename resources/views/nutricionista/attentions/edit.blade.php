...
@section('title', 'Editar Atención - NutriFit')
        ...
        <main class="flex-grow">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                ...
                <nav class="mb-6 flex items-center gap-2 text-sm">
                    ...
                    <span class="material-symbols-outlined text-gray-400 text-sm">chevron_right</span>
                    <span class="text-gray-700 dark:text-gray-300 font-medium">Editar Atención</span>
                </nav>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2 order-2 lg:order-1">
                        <form method="POST" action="{{ route('nutricionista.attentions.update', $appointment) }}"
                            id="attention-form">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex gap-2">
                                            <input type="number" step="0.01" id="weight-input" value="{{ old('weight', $appointment->attention->attentionData->weight ?? '') }}"
                                        ...
                                        <input type="hidden" id="weight" name="weight" value="{{ old('weight', $appointment->attention->attentionData->weight ?? '') }}" required>
                                        @error('weight')
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01" id="height" name="height"
                                            value="{{ old('height', $appointment->attention->attentionData->height ?? '') }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01" id="waist" name="waist" value="{{ old('waist', $appointment->attention->attentionData->waist ?? '') }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01" id="hip" name="hip" value="{{ old('hip', $appointment->attention->attentionData->hip ?? '') }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01" id="neck" name="neck" value="{{ old('neck', $appointment->attention->attentionData->neck ?? '') }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01" id="wrist" name="wrist" value="{{ old('wrist', $appointment->attention->attentionData->wrist ?? '') }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01" id="arm_contracted" name="arm_contracted"
                                            value="{{ old('arm_contracted', $appointment->attention->attentionData->arm_contracted ?? '') }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01" id="arm_relaxed" name="arm_relaxed"
                                            value="{{ old('arm_relaxed', $appointment->attention->attentionData->arm_relaxed ?? '') }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01" id="thigh" name="thigh" value="{{ old('thigh', $appointment->attention->attentionData->thigh ?? '') }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01" id="calf" name="calf" value="{{ old('calf', $appointment->attention->attentionData->calf ?? '') }}"
                                    ...
                                    <div>
                                        ...
                                        <select id="activity_level" name="activity_level"
                                            ...
                                            required>
                                            <option value="sedentary" {{ old('activity_level', $appointment->attention->attentionData->activity_level ?? 'moderate') == 'sedentary' ? 'selected' : '' }}>Sedentario (poco o ningún ejercicio)</option>
                                            <option value="light" {{ old('activity_level', $appointment->attention->attentionData->activity_level ?? 'moderate') == 'light' ? 'selected' : '' }}>Ligero (ejercicio 1-3 días/semana)</option>
                                            <option value="moderate" {{ old('activity_level', $appointment->attention->attentionData->activity_level ?? 'moderate') == 'moderate' ? 'selected' : '' }}>Moderado (ejercicio 3-5 días/semana)</option>
                                            <option value="active" {{ old('activity_level', $appointment->attention->attentionData->activity_level ?? 'moderate') == 'active' ? 'selected' : '' }}>Activo (ejercicio 6-7 días/semana)</option>
                                            <option value="very_active" {{ old('activity_level', $appointment->attention->attentionData->activity_level ?? 'moderate') == 'very_active' ? 'selected' : '' }}>Muy activo (ejercicio intenso diario)</option>
                                        </select>
                                    ...
                                    <div>
                                        ...
                                        <select id="nutrition_goal" name="nutrition_goal"
                                            ...
                                            <option value="deficit" {{ old('nutrition_goal', $appointment->attention->attentionData->nutrition_goal ?? 'maintenance') == 'deficit' ? 'selected' : '' }}>Pérdida de peso (déficit calórico)</option>
                                            <option value="maintenance" {{ old('nutrition_goal', $appointment->attention->attentionData->nutrition_goal ?? 'maintenance') == 'maintenance' ? 'selected' : '' }}>Mantenimiento</option>
                                            <option value="surplus" {{ old('nutrition_goal', $appointment->attention->attentionData->nutrition_goal ?? 'maintenance') == 'surplus' ? 'selected' : '' }}>Ganancia de masa (superávit calórico)</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div
                                ...
                                <div class="mb-6">
                                    ...
                                    <textarea id="diagnosis" name="diagnosis" rows="6"
                                        ...
                                        required>{{ old('diagnosis', $appointment->attention->diagnosis ?? '') }}</textarea>
                                    @error('diagnosis')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea id="recommendations" name="recommendations" rows="8"
                                        ...
                                        required>{{ old('recommendations', $appointment->attention->recommendations ?? '') }}</textarea>
                            ...
                            <div class="mt-6" x-data="{ 
                                ...
                                <div class="flex gap-4">
                                    ...
                                    <button type="button" @click="handleSaveClick()" id="submit-btn"
                                        ...
                                        <span id="submit-text">Actualizar Atención</span>
                                    </button>
                                </div>
                                ...
                                <div x-show="showConfirmModal" x-cloak
                                    ...
                                    <div @click.away="!submitting && (showConfirmModal = false)"
                                        ...
                                        <div class="text-center mb-6">
                                            ...
                                            <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">
                                                <span x-show="!submitting">¿Confirmar actualización de atención?</span>
                                                <span x-show="submitting">Actualizando atención...</span>
                                            </h3>
                                            <p class="text-gray-600 dark:text-gray-400 mb-3" x-show="!submitting">
                                                Esta acción actualizará todos los datos de la atención médica del paciente.
                                            </p>
                                            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3" x-show="!submitting">
                                                <p class="text-sm text-blue-800 dark:text-blue-200 flex items-center justify-center gap-2">
                                                    <span class="material-symbols-outlined text-base">info</span>
                                                    <span class="font-semibold">Los cambios serán guardados permanentemente.</span>
                                                </p>
                                            </div>
                                        ...
                                        <div class="flex gap-3">
                                            ...
                                            <button type="button" 
                                                ...
                                                <span x-text="submitting ? 'Actualizando...' : 'Sí, actualizar'"></span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
