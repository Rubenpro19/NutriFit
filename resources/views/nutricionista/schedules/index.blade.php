                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div class="bg-gradient-to-r from-green-600 to-emerald-600 px-6 py-4">
                        <div class="flex items-center justify-between">
                            ...
                            <button type="submit" 
                                    :disabled="submitting"
                                    class="bg-white text-green-600 px-6 py-2.5 rounded-lg font-semibold hover:bg-green-50 hover:shadow-lg hover:scale-105 active:scale-95 transition-all duration-200 flex items-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:scale-100 disabled:hover:shadow-none">
                                ...
                                <span x-text="submitting ? 'Guardando...' : 'Guardar horario'"></span>
                            </button>
                        </div>
                    </div>
