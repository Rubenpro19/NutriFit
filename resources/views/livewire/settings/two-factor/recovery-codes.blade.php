...
>
    <div class="px-6 space-y-2">
        <div class="flex items-center gap-2">
            ...
            <flux:heading size="lg" level="3">{{ __('Códigos de recuperación de 2FA') }}</flux:heading>
        </div>
        <flux:text variant="subtle">
            {{ __('Los códigos de recuperación te permiten recuperar el acceso si pierdes tu dispositivo 2FA. Almacénalos en un gestor de contraseñas seguro.') }}
        </flux:text>
    </div>
