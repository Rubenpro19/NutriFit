        ...
        <div class="container mx-auto px-4 py-16">
            <div class="grid gap-12 lg:grid-cols-2">
                ...
                <div class="rounded-2xl bg-white p-8 shadow-xl">
                    <div class="mb-6">
                        <h2 class="mb-2 text-2xl font-bold text-green-900">Envíanos un mensaje</h2>
                ...
                <div class="space-y-8">
                    <!-- Información de contacto -->
                    <div class="rounded-2xl bg-white p-8 shadow-xl">
                        <h2 class="mb-6 text-2xl font-bold text-green-900">Información de Contacto</h2>
                        
                        <div class="space-y-6">
                            <!-- Email -->
                            <div class="flex items-start gap-4">
                                <div class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-green-100">
                                    <span class="material-symbols-outlined text-2xl text-green-700">mail</span>
                                </div>
                                <div>
                                    <h3 class="mb-1 font-semibold text-gray-900">Email</h3>
                                    <a href="mailto:contacto@nutrifit.ec" class="text-green-600 hover:text-green-700">
                            ...
                            <div class="flex items-start gap-4">
                                <div class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-blue-100">
                                    <span class="material-symbols-outlined text-2xl text-blue-700">phone</span>
                                </div>
                                <div>
                                    <h3 class="mb-1 font-semibold text-gray-900">Teléfono</h3>
                                    <a href="tel:+593987654321" class="text-blue-600 hover:text-blue-700">
                                        +593 98 765 4321
                                    </a>
                                    <p class="text-sm text-gray-600">Lun - Vie: 9:00 AM - 6:00 PM</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-4">
                                <div class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-emerald-100">
                                    <span class="material-symbols-outlined text-2xl text-emerald-700">chat</span>
                                </div>
                                <div>
                                    <h3 class="mb-1 font-semibold text-gray-900">WhatsApp</h3>
                                    <a href="https://wa.me/593987654321" target="_blank" class="text-emerald-600 hover:text-emerald-700">
                                        +593 98 765 4321
                                    </a>
                                    <p class="text-sm text-gray-600">Atención inmediata</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-4">
                                <div class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-purple-100">
                                    <span class="material-symbols-outlined text-2xl text-purple-700">location_on</span>
                                </div>
                                <div>
                    ...
                    <div class="rounded-2xl bg-gradient-to-br from-green-50 to-green-100 p-8 shadow-xl">
                        <div class="mb-4 flex items-center gap-3">
                            <span class="material-symbols-outlined text-3xl text-green-700">schedule</span>
                            <h2 class="text-2xl font-bold text-green-900">Horarios de Atención</h2>
                        </div>
                        
                        <div class="space-y-3">
                            <div class="flex justify-between border-b border-green-200 pb-2">
                                <span class="font-medium text-gray-700">Lunes - Viernes</span>
        ...
        <div class="bg-white py-16">
            <div class="container mx-auto px-4">
                <div class="mb-12 text-center">
                    <span class="material-symbols-outlined mb-4 text-6xl text-green-700">help</span>
                    <h2 class="mb-4 text-3xl font-bold text-green-900">Preguntas Frecuentes</h2>
                    <p class="text-gray-600">Respuestas rápidas a las preguntas más comunes</p>
                </div>

                <div class="mx-auto max-w-3xl space-y-4">
                    <details class="group rounded-lg border border-gray-200 bg-white p-6 shadow-sm transition hover:shadow-md">
