...
<body class="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-rose-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex flex-col">
    ...
    <main class="flex-grow">
        ...
        <nav class="mb-6 flex items-center gap-2 text-sm">
            ...
            <a href="{{ route('paciente.appointments.index') }}" class="text-green-600 dark:text-green-400 hover:underline transition-colors">Mis Citas</a>
            <span class="material-symbols-outlined text-gray-400 text-sm">chevron_right</span>
        ...
        <div class="mb-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-4 sm:p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between gap-3">
                <div class="flex items-center gap-3 flex-1 min-w-0">
                    <a href="{{ route('paciente.appointments.index') }}" class="text-gray-700 dark:text-gray-300 hover:text-green-600 dark:hover:text-green-400 hover:scale-110 transition-all">
                            ...
                            <div x-show="showModal" x-cloak
                                ...
                                <div @click.away="showModal = false"
                                    ...
                                    <div class="flex gap-3">
                                        ...
                                        <form method="POST" action="{{ route('paciente.appointments.cancel', $appointment) }}" class="flex-1">
                                            @csrf
                                            <button type="submit"
