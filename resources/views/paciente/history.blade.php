                    ...
                    <div class="block sm:hidden p-4 space-y-4">
                        @foreach($attentions->reverse() as $attention)
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 border border-gray-200 dark:border-gray-600">
                                ...
                                @endif
                                <div class="mt-3">
                                    <a href="{{ route('paciente.appointments.show', $attention->appointment_id) }}" 
                                       class="w-full inline-flex items-center justify-center gap-2 px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-semibold rounded-lg transition-colors duration-200 shadow-sm hover:shadow-md">
