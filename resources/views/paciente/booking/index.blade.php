            ...
            @if($nutricionistas->count() > 0)
                <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    @foreach($nutricionistas as $nutricionista)
                        <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-lg dark:border-gray-700 dark:bg-gray-800 transition hover:shadow-xl hover:border-purple-300 dark:hover:border-purple-600">
                            <div class="text-center mb-6">
                                <div class="w-24 h-24 mx-auto rounded-full bg-gradient-to-br from-purple-600 to-pink-600 flex items-center justify-center text-white font-bold text-3xl mb-4 shadow-lg">
                            ...
                            @if($nutricionista->schedules_count > 0)
                                <a href="{{ route('paciente.booking.schedule', $nutricionista) }}" 
                                   class="block w-full rounded-lg bg-gradient-to-r from-purple-600 to-pink-600 px-4 py-3 text-center font-semibold text-white transition hover:from-purple-700 hover:to-pink-700 flex items-center justify-center gap-2">
            ...
            @else
                <div class="py-16 text-center">
                    ...
                    <a href="{{ route('paciente.dashboard') }}" 
                       class="mt-6 inline-flex items-center gap-2 rounded-lg bg-purple-600 px-6 py-3 font-semibold text-white transition hover:bg-purple-700">
