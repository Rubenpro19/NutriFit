    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8 rounded-2xl bg-gradient-to-r from-purple-600 to-pink-600 p-8 text-white shadow-lg">
            ...
            <div class="mb-8 grid gap-6 md:grid-cols-3">
                <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-lg dark:border-gray-700 dark:bg-gray-800 transition hover:shadow-xl">
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-lg dark:border-gray-700 dark:bg-gray-800 transition hover:shadow-xl">
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-4xl font-bold text-green-600 dark:text-green-400">{{ $stats['completadas'] }}</p>
                    </div>
                </div>
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-lg dark:border-gray-700 dark:bg-gray-800 transition hover:shadow-xl">
                    <div class="text-center">
                        ...
                        <p class="mt-2 text-4xl font-bold text-yellow-600 dark:text-yellow-400">{{ $stats['pendientes'] }}</p>
                    </div>
                </div>
            </div>
                ...
                <div class="lg:col-span-2 rounded-2xl border-2 border-purple-500 bg-white p-6 shadow-lg dark:border-purple-400 dark:bg-gray-800">
                        ...
                        <div class="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg p-6">
                            <div class="flex items-start gap-4 mb-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-500">{{ $nextAppointment->nutricionista->email }}</p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-3">
                                ...
                                <form method="POST" action="{{ route('paciente.appointments.cancel', $nextAppointment) }}" class="flex-1" onsubmit="return confirm('¿Estás seguro de cancelar esta cita?')">
                                    @csrf
                                    <button type="submit" class="w-full rounded-lg bg-red-600 px-4 py-3 text-center font-semibold text-white transition hover:bg-red-700 flex items-center justify-center gap-2">
                    ...
                    @else
                        <div class="py-12 text-center">
                            ...
                            <a href="{{ route('paciente.booking.index') }}" class="inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-purple-600 to-pink-600 px-6 py-3 font-semibold text-white transition hover:from-purple-700 hover:to-pink-700">
                    ...
                    @if($nutricionistas->count() > 0)
                        <div class="space-y-3">
                            @foreach($nutricionistas->take(5) as $nutricionista)
                                <div class="flex items-center gap-3 p-3 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-750 transition">
                                    <div class="w-12 h-12 rounded-full bg-gradient-to-br from-purple-600 to-pink-600 flex items-center justify-center text-white font-bold">
                                        {{ $nutricionista->initials() }}
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <p class="font-semibold text-gray-900 dark:text-white truncate">{{ $nutricionista->name }}</p>
                                        <p class="text-xs text-gray-500 dark:text-gray-400">{{ $nutricionista->schedules_count }} horarios</p>
                                    </div>
                                    <a href="{{ route('paciente.booking.schedule', $nutricionista) }}" class="flex-shrink-0 rounded-lg bg-purple-600 px-3 py-2 text-sm font-medium text-white transition hover:bg-purple-700">
                                        Agendar
                                    </a>
                                </div>
                            @endforeach
                        ...
                        <a href="{{ route('paciente.booking.index') }}" class="mt-4 block text-center text-sm text-purple-600 dark:text-purple-400 hover:underline">
