...
return [
    ...
    */
    ...
    | component will be rendered as the entire page.
    |
    | There are two ways to specify a layout:
    |   1. As a Blade template path
    |   2. As a class name
    |
    */
    ...
    */
    ...
    | before the file is validated or stored permanently. All file uploads
    | are directed to a global endpoint for temporary storage. The config
    | items below are used for customizing the way uploads are handled.
    |
    */

    'temporary_file_upload' => [
        'disk' => null,        // Example: 'local', 's3'              Default: 'default'
        'rules' => ['required', 'file', 'max:10240'],       // (Max 10MB) Rules for temporary file uploads
    ...
    | any non-standard configuration, you can change this.
    |
    */
    ...
    | potentially stale cached data. If you experience issues with components
    | not updating when using the back button, disabling this might help.
    |
    */
